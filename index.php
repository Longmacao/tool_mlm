...
if(count($argv) == 1){
    while(true){
        ...
        echo "5. Login google\n";
        echo "6. upload youtube short\n";
        echo "7. Hien thi danh sach page_id\n";
        echo "0. exit\n";
        ...
        if($key == 1){
            ...
            echo "========================\n";
            echo "=         Tool         =\n";
            echo "= upload youtube short =\n";
            echo "========================\n";
            echo "\n";
            $folder = readline("Nhap duong dan video: ");
            $page_id = readline("Nhap page_id: ");
            $desc_text = readline("Nhap duong dan file description: ");
            ...
            echo "========================\n";
            echo "=         Tool         =\n";
            echo "=  Get list page_id    =\n";
            echo "========================\n";
            echo "\n";
            
            $data = request('https://congminh.name.vn/tool/index.php?type=get_channel');
            if($data){
                $data = json_decode($data);
            }
            foreach($data as $item){
                echo 'Page_id: '.$item->page_id.' ('.$item->type.')'.($item->type == 'youtube_page' ? '- nguoi dung xac dinh' : '')."\n";
            }
        }else if($key == 0){
            break;
        }
